function fv = full_body_2018(n)
disp('now.................')
disp(n)
sub_dir = n;

mkdir full_body_2018_gfd

images_directory = ['full_body_2018/',num2str(sub_dir)];

mkdir(sprintf('./full_body_2018_centered/%i', sub_dir));

out_directory = ['full_body_2018_centered/',num2str(sub_dir)];
...
save(['full_body_2018_gfd/' num2str(sub_dir) '.mat'] ,'gfd_transpose');
fv = gfd_transpose;
