function fv = upper_half_2017(n)
disp('now.................')
disp(n)
sub_dir = n;

mkdir upper_half_2017_gfd

images_directory = ['upper_half_2017/',num2str(sub_dir)];

mkdir(sprintf('./upper_half_2017_centered/%i', sub_dir));

out_directory = ['upper_half_2017_centered/',num2str(sub_dir)];
...
save(['upper_half_2017_gfd/' num2str(sub_dir) '.mat'] ,'gfd_transpose');
fv = gfd_transpose;
